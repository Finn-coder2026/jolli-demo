...
// This script is executed with osascript -l JavaScript
// It finds an existing tab with the URL and reloads it, or opens a new tab

// biome-ignore lint/correctness/noUnusedVariables: called externally by osascript
function run(argv) {
