/**
 * SettingsProfile - Profile page within the Settings layout.
 *
 * Reuses the Profile component content but renders within the SettingsLayout.
 */
...
/**
 * Profile settings page showing user information and language preferences.
 */
export function SettingsProfile({ userInfo }: SettingsProfileProps): ReactElement {
			...
			<div className="space-y-8 max-w-2xl">
				...
				>
					<SettingsRow label={content.nameLabel.value} description={content.nameDescription.value}>
						<Input value={userInfo?.name} disabled className="max-w-xs" data-testid="profile-name-input" />
					</SettingsRow>
