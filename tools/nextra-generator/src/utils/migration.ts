...
export function parseNextra3ThemeConfig(content: string): { config: Nextra3Config; warnings: Array<string> } {
	...
	// Extract footer text: footer: { text: 'Footer Text' } or text: 'Footer · Generated by Jolli'
	const footerMatch = content.match(/footer:\s*\{\s*text:\s*['"]([^'"]+)['"]/);
	if (footerMatch) {
		// Remove "Generated by Jolli" suffix as it will be added by 4.x generator
		let footerText = footerMatch[1];
		footerText = footerText.replace(/\s*·?\s*Generated by Jolli\s*$/i, "").trim();
		if (footerText) {
