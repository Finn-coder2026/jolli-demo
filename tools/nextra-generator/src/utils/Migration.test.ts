...
describe("parseNextra3ThemeConfig", () => {
  ...
  docsRepositoryBase: 'https://github.com/example/repo/tree/main/docs',
	...
	test("extracts footer text and removes Jolli branding", () => {
		const content = `export default {
  footer: {
    text: 'My Site · Generated by Jolli',
  },
}`;
		const { config } = parseNextra3ThemeConfig(content);
...
//
// 		// Should preserve custom title "🚀 Getting Started"
...
// 				type: "page",
// 				items: {
// 					introduction: "🚀 Getting Started", // User customized title with emoji
...
// 		expect(docsEntry.items.introduction).toBe("🚀 Getting Started");
